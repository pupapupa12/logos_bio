    ...
    <div class="l__1260">
      <div class="line__hero__flex">
        <div class="line__hero__linkname" data-ix="load1">Resources &gt; Technical Documents <span class="line__hero__linkname-red">&gt;</span>
          <span class="line__hero__linkname-red">White Papers/Posters</span>
        </div>
        <div class="line__hero__f1" data-ix="load-2">White Papers/Posters</div>
    ...
    <div class="l__1260">
      <div class="sidebar__flex">
        <div class="sidebar__left-col">
          ...
          <?php echo do_shortcode('[ajax_load_more_filters id="white_papers_posters_filter" target="4545974346"]');?>
        ...
        <?php echo do_shortcode('[ajax_load_more id="4545974346" target="white_papers_posters_filter" orderby="menu_order" filters="true" repeater="template_8" post_type="white_papers_posters" posts_per_page="8"]');?>
