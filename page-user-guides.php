    ...
    <div class="l__1260">
      <div class="line__hero__flex">
        <div class="line__hero__linkname" data-ix="load1">Resources &gt; Technical Documents <span class="line__hero__linkname-red">&gt;</span>
          <span class="line__hero__linkname-red">User Guides</span>
        </div>
        <div class="line__hero__f1" data-ix="load-2">User Guides</div>
    ...
    <div class="l__1260">
      <div class="sidebar__flex">
        <div class="sidebar__left-col">
          ...
          <?php echo do_shortcode('[ajax_load_more_filters id="user_guides_filter" target="3339320867"]');?>
        ...
        <?php echo do_shortcode('[ajax_load_more id="3339320867" target="user_guides_filter" orderby="menu_order" filters="true" repeater="template_10" post_type="user_guides" posts_per_page="8"]');?>
