...
<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
  ...
  <div class="l__relative">
    ...
    <div class="line__hero center">
      <div class="l__1260">
        <div class="line__hero__linkname" data-ix="load1">Cell Counting  <span class="line__hero__linkname-red">&gt;</span> Consumables & Accessories  <span class="line__hero__linkname-red">&gt;</span> <span class="line__hero__linkname-red">


        <?php
        $terms = get_the_terms( get_the_ID(), 'cell_counting_acc_category' ); // 카테고리 맞는 이름으로 변경
        if(!empty($terms)){
    ...
    <div class="l__1260">
      <div class="etc__com01">
        ...
        <?php if ( $oder_link ) : ?>
            ...
            <a href="<?php the_field( 'oder_link' ); ?>" target="blank" class="etc__com01__btn ip w-inline-block">
              <div>Order Now</div>
            </a>
