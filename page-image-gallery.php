  ...
  <div class="line__hero">
    <div class="l__1260">
      <div class="line__hero__flex">
        <div class="line__hero__linkname" data-ix="load1">Customer Reviews  <span class="line__hero__linkname-red">&gt;</span> <span class="line__hero__linkname-red">Image Gallery</span></div>
        <div class="line__hero__f1" data-ix="load-2">Image Gallery</div>
    ...
    <div class="l__1260">
      <div class="sidebar__flex">
        <div class="sidebar__left-col">
          ...
          <?php echo do_shortcode('[ajax_load_more_filters id="image_gallery_filter" target="7284702574"]');?>
        ...
        <div class="sidebar__right-col-two">
          ...
          <?php echo do_shortcode('[ajax_load_more id="7284702574" target="image_gallery_filter" orderby="menu_order" filters="true" repeater="template_5" post_type="image_gallery" posts_per_page="6" taxonomy="image_gallery_category" ]');?>
